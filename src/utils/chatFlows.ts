  ...
  const options = {
    ...
    technical: {
      pt: [
        ...
        { id: 'data_loss', label: '😱 Perdi meus dados', nextStep: 'data_loss' },
        { id: 'main_menu', label: '← Voltar ao Menu Principal', nextStep: 'main_menu' }
      ],
      en: [
...
export const getAnswerForStep = (step: string, language: ChatLanguage): string => {
  const answers = {
    ...
    filters: {
      pt: '🎯 Usar filtros avançados:\n\n1. Selecione período de datas\n2. Escolha campanha específica\n3. Filtre por produto\n4. Selecione plataforma (Meta/Shopify)\n5. Aplique filtros combinados\n\n💡 Os filtros afetam gráficos e estatísticas em tempo real.',
